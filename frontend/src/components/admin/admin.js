...
function Admin() {
  ...
  function handleOpenSupplier(obj) {
    setEdit(obj);
    setOpenSupplier(true);
  }
  function handleCloseSupplier(obj) {
    /* setEdit(obj); */
  ...
  return (
                ...
                {rows.map((row) => (
                  ...
                  >
                    ...
                    <TableCell align="right">
                      ...
                      <Button
                        onClick={() => deleteItem(row, refresh, setRefresh)}
                      >
                        <img
                          src={deleteIcon}
                          alt=""
	...
	/> */}
      ...
      >
        <Box sx={style}>
          ...
          <div className="flex-row">
            ...
            <div>
              <Select
                ...
                label="Supplier"
                onChange={(e) =>
                  setEdit({ ...edit, supplier_id: e.target.value })
                }
              >
                {suppliers.map((s) => {
          ...
          <div className="flex-row">
            <div>
              <Button
                onClick={() => updateItem(edit, refresh, setRefresh)}
                variant="contained"
              >
                Update
              </Button>
      ...
      >
        <Box sx={style}>
          <div className="modal-title">Create Item</div>
          <div className="flex-row">
            <div>
              <TextField
                id="outlined-basic"
          ...
          <div className="flex-row">
            ...
            <div>
              <TextField
                ...
                fullWidth
                onChange={(e) =>
                  setEdit({ ...edit, product_id: e.target.value })
                }
              />
            </div>
          </div>
          <div className="flex-row">
            <div>
              <Button
                onClick={() =>
                  createItem(edit, refresh, setRefresh, setOpenCreate)
                }
                variant="contained"
              >
                Add
      ...
      >
        <Box sx={style}>
          <div className="modal-title">Supplier Requests</div>
          <div className="flex-row">
            <div>
              <TableContainer component={Paper}>
                  ...
                  <TableBody>
                    {rows.map((row) => (
                      ...
                      >
                        ...
                        <TableCell align="right">{row.product_id}</TableCell>
                        <TableCell align="right">
                          <button className="reorder-button">Reject</button>
                          <button className="recieve-button">Accept</button>
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
          ...
          <div className="flex-row">
            <div>
              <Button onClick={() => handleCloseSupplier()}>Close</Button>
            </div>
          </div>
        </Box>
      </Modal>
